...
[pscustomobject]@{Result='PASS';Phase='9B';Static='PASS';Build=$(if($SkipBuild){'SKIPPED'}else{'PASS'});Live=$(if($SkipLive){'SKIPPED'}else{'PASS'});Details=$details;Phase9C='NOT_STARTED';WireProtocolV1='NOT_FROZEN'}
