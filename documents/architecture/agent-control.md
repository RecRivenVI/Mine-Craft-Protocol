...
> Prior UX closeout: historical PARTIAL; see `validations/results/core/core-ux-closeout-20260905.json`.
...
Round 1 classification is indexed in `validations/tests/core/control/control-mode-surface.json`:
...
Round 1 acceptance: `validations/tests/core/control/Invoke-ControlRound1Gate.ps1` and
`validations/results/core/agent-control-round1-20260905.json`. This is working-tree candidate
...
Current automated entry points: [static gate](../../validations/tests/core/control/Invoke-ControlImplementationStaticGate.ps1)
and [implementation smoke](../../validations/tests/core/control/Invoke-ControlImplementationSmoke.ps1). Human Esc/IME/focus/host-cursor validation,
