...
> Optional extensions: governed separately by `documents/product/extensions.md`
...
└── OPTIONAL EXTENSION PORTFOLIO
    └── governed only by documents/product/extensions.md
```
...
> `documents/product/extensions.md`
