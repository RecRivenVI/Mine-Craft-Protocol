...
try {
    ...
    $schema = Get-Content -LiteralPath 'components\protocol-schema\src\main\openapi\minecraft-control-v0.json' -Raw | ConvertFrom-Json
    ...
    $hookGate = & '.\validations\tests\compatibility\phase7\Invoke-Phase7HookCompatibilityGate.ps1'
