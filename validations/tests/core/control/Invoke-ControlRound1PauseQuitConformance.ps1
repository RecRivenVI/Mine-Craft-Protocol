...
$exit=& (Join-Path $PSScriptRoot '../ux/Invoke-CoreExitConformance.ps1') -BaseUri $base -TokenFile $TokenFile -ExpectedTarget $ExpectedTarget -InstanceDirectory $InstanceDirectory
