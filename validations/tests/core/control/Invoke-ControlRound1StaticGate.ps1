...
$shared=Get-Content (Join-Path $root 'components/runtime-safety/src/main/java/io/github/recrivenvi/minecraftprotocol/safety/AgentControlSession.java') -Raw
...
$server=Get-Content (Join-Path $root 'components/companion/src/server.ts') -Raw
