...
$schema=Get-Content (
    Join-Path $root 'components\protocol-schema\src\main\openapi\minecraft-control-v0.json') -Raw|ConvertFrom-Json
Assert-True ($schema.info.version -eq '0.0.1-control-r24') 'OpenAPI version after explicit Control Round 1 evolution'
