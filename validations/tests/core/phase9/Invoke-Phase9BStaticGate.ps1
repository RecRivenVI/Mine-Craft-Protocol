...
$plan=Get-Content (Join-Path $root 'documents/phases/phase9-implementation-plan.md') -Raw
...
A ($schema.info.version -eq '0.0.1-control-r24') 'OpenAPI version after explicit Control Round 1 evolution'
