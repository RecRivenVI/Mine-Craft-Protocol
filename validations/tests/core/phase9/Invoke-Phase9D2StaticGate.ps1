...
try {
    ...
    $foundation = Get-Content -LiteralPath (Join-Path $root 'components/runtime-safety/src/main/java/io/github/recrivenvi/minecraftprotocol/safety/PersistentWriteSafetyFoundation.java') -Raw
