...
$plan = Get-Content -LiteralPath (Join-Path $root 'documents/phases/phase9-implementation-plan.md') -Raw
$executionPlan = Get-Content -LiteralPath (Join-Path $root 'documents/product/execution-plan.md') -Raw
