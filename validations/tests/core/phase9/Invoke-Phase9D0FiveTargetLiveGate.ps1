...
$runs = @(
    @{ Target='1.20.1-forge'; Task=':versions:1.20.1-forge:runClient'; Dir='instances\1.20.1-forge\client'; Port=25581 },
    @{ Target='1.21.1-neoforge'; Task=':versions:1.21.1-neoforge:runClient'; Dir='instances\1.21.1-neoforge\client'; Port=25581 },
    @{ Target='26.1.2-neoforge'; Task=':versions:26.1.2-neoforge:runClient'; Dir='instances\26.1.2-neoforge\client'; Port=25582 },
    @{ Target='26.2-neoforge'; Task=':versions:26.2-neoforge:runClient'; Dir='instances\26.2-neoforge\client'; Port=25582 },
    @{ Target='26.2-fabric'; Task=':versions:26.2-fabric:runClient'; Dir='instances\26.2-fabric\client'; Port=25583 }
)
...
try {
    ...
    $results = foreach ($run in $runs) {
        ...
        $v1 = & '.\validations\tests\releases\phase8\Invoke-Phase8TargetSmoke.ps1' -BaseUri $base -TokenFile $tokenFile `
        ...
        if ($SkipStorageRead) {
            ...
            $storage = & '.\validations\tests\core\phase9\Invoke-Phase9D0StorageReadConformance.ps1' `
