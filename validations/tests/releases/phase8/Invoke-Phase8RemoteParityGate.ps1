...
try {
    ...
    $client = Read-RemoteFile 'components\companion\src\runtime-client.ts'
    $server = Read-RemoteFile 'components\companion\src\server.ts'
    $conditionConformance = Read-RemoteFile 'validations\tests\releases\phase8\Invoke-Phase8ConditionConformance.ps1'
    $dependencyAudit = Read-RemoteFile 'validations\tests\releases\phase8\DependencyAudit.ps1'
    $dependencyAuditTests = Read-RemoteFile 'validations\tests\releases\phase8\Invoke-Phase8DependencyAuditClassifierTests.ps1'
    $localGateSource = Read-RemoteFile 'validations\tests\releases\phase8\Invoke-Phase8LocalGate.ps1'
    ...
    $evidence = Read-RemoteFile 'documents/phases/phase8-hardening-evidence.md'
    ...
    $remoteGateRelativePath = 'validations/tests/releases/phase8/Invoke-Phase8RemoteParityGate.ps1'
    ...
    if (-not $SkipBuild) {
        ...
        try {
            ...
            $localGate = & '.\validations\tests\releases\phase8\Invoke-Phase8LocalGate.ps1' @arguments
    ...
    $criticalFiles = @(
        'components/companion/src/runtime-client.ts',
        'components/companion/src/server.ts',
        'components/protocol-schema/src/main/openapi/minecraft-control-v0.json',
        'validations/tests/releases/phase8/DependencyAudit.ps1',
        'validations/tests/releases/phase8/Invoke-Phase8DependencyAuditClassifierTests.ps1',
        'validations/tests/releases/phase8/Invoke-Phase8LocalGate.ps1',
        'validations/tests/releases/phase8/Invoke-Phase8HardeningStaticGate.ps1',
