...
$runs = @(
    @{ Target='1.20.1-forge'; Task=':versions:1.20.1-forge:runClient'; Directory='instances\1.20.1-forge\client'; Port=25581; Backend='any'; World=$true },
    @{ Target='1.21.1-neoforge'; Task=':versions:1.21.1-neoforge:runClient'; Directory='instances\1.21.1-neoforge\client'; Port=25581; Backend='any'; World=$true },
    @{ Target='26.1.2-neoforge'; Task=':versions:26.1.2-neoforge:runClient'; Directory='instances\26.1.2-neoforge\client'; Port=25582; Backend='any'; World=$true },
    @{ Target='26.2-neoforge'; Task=':versions:26.2-neoforge:runClient'; Directory='instances\26.2-neoforge\client'; Port=25582; Backend='opengl'; World=$true },
    @{ Target='26.2-neoforge'; Task=':versions:26.2-neoforge:runClientVulkan'; Directory='validations\.local\vulkan\26.2-neoforge'; Port=25582; Backend='vulkan'; World=$false },
    @{ Target='26.2-fabric'; Task=':versions:26.2-fabric:runClient'; Directory='instances\26.2-fabric\client'; Port=25583; Backend='opengl'; World=$true },
    @{ Target='26.2-fabric'; Task=':versions:26.2-fabric:runClientVulkan'; Directory='validations\.local\vulkan\26.2-fabric'; Port=25583; Backend='vulkan'; World=$false }
)
...
try {
    ...
    $results = foreach ($run in $runs) {
        ...
        $smoke = & '.\validations\tests\releases\phase8\Invoke-Phase8TargetSmoke.ps1' @parameters |
